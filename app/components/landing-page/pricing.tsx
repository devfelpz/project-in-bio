		...
		<div className="my-[150px] flex flex-col items-center gap-14">
			<div className="flex flex-col items-center gap-6">
				<h3 className="text-4xl font-bold text-white">
					Um valor acesível para todos
				</h3>
				<p className="text-body text-xl text-center">
					Juntes-se à uma comunidade de criadores profissionais que já estão
					elevando a sua <br /> presença online. Teste gratuitamente por{' '}
			...
			<div className="flex items-end gap-9">
				<div className="w-[304px] p-8 flex flex-col gap-7 rounded-2xl border-border-[#1e1e1e]">
					...
					<div className="flex items-center gap-2">
						...
						<span className="text-headline  text-2xl">/mês</span>
					</div>
